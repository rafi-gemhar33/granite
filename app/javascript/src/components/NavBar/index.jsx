      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
        <div className="flex h-16 justify-between">
          ...
          <div className="flex items-center justify-end gap-x-4">
            <span className="font-regular transition focus:outline-none inline-flex items-center border-b-2 border-transparent px-2 pt-1 text-sm leading-5 text-bb-gray-600 text-opacity-50 duration-150 ease-in-out focus:text-bb-gray-700">
